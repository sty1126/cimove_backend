...
CREATE TABLE INVENTARIOLOCAL (
    ...
    ID_PRODUCTO_INVENTARIOLOCAL BIGINT NOT NULL,
...
CREATE TABLE PROVEEDORPRODUCTO (
    ...
    ID_PRODUCTO_PROVEEDORPRODUCTO BIGINT NOT NULL,
...
CREATE TABLE DETALLEORDENCOMPRA (
    ...
    ID_PRODUCTO_DETALLEORDENCOMPRA BIGINT NOT NULL,
...
CREATE TABLE MOVPRODUCTO (
    ...
    ID_PRODUCTO_MOVIMIENTO BIGINT NOT NULL,
...
CREATE TABLE AUDITORIA (
    ...
    ID_SEDE_AUDITORIA INT,
    ID_TIPOMOV_AUDITORIA INT,

    ESTADO_AUDITORIA CHAR(1) NOT NULL DEFAULT 'A',

    FOREIGN KEY (ID_USUARIO_AUDITORIA) REFERENCES USUARIO(ID_EMPLEADO_USUARIO),
    FOREIGN KEY (ID_SEDE_AUDITORIA) REFERENCES SEDE(ID_SEDE),
    FOREIGN KEY (ID_TIPOMOV_AUDITORIA) REFERENCES TIPOMOV(ID_TIPOMOV)
);
...
CREATE TABLE FACTURA (
    ...
    FOREIGN KEY (ID_SEDE_FACTURA) REFERENCES SEDE(ID_SEDE)
);

CREATE TABLE DETALLEFACTURA (
    ID_DETALLEFACTURA SERIAL PRIMARY KEY,
    ID_FACTURA_DETALLEFACTURA INT NOT NULL,
    ID_PRODUCTO_DETALLEFACTURA BIGINT NOT NULL,
...
CREATE TABLE NOTIFICACION (
    ...
    ESTADO_NOTIFICACION CHAR(1) NOT NULL DEFAULT 'P'
);

CREATE TABLE SERVICIOTECNICO (
    ID_SERVICIOTECNICO SERIAL PRIMARY KEY,
    ID_SEDE_SERVICIOTECNICO INT NOT NULL,
    ID_PROVEEDOR_SERVICIOTECNICO VARCHAR(50) DEFAULT 'PROV_TEMP_123',
    ID_CLIENTE_SERVICIOTECNICO INT NOT NULL,
    ID_FACTURA_SERVICIOTECNICO INT, 
    NOMBRE_SERVICIOTECNICO VARCHAR(255),
    DESCRIPCION_SERVICIOTECNICO VARCHAR(500),
    FECHA_SERVICIOTECNICO DATE,
    FECHA_ENTREGA_SERVICIOTECNICO DATE,
    TIPO_DANO_SERVICIOTECNICO VARCHAR(100),
    CLAVE_DISPOSITIVO_SERVICIOTECNICO VARCHAR(100),
    COSTO_SERVICIOTECNICO INT,
    ABONO_SERVICIOTECNICO INT,
    GARANTIA_APLICA_SERVICIOTECNICO BOOLEAN DEFAULT FALSE,
    FECHA_GARANTIA_SERVICIOTECNICO DATE,
    NUMERO_CONTACTO_ALTERNATIVO_SERVICIO VARCHAR(15),
    ESTADOTECNICO_SERVICIOTECNICO VARCHAR(30) DEFAULT 'D' NOT NULL,
    AUTORIZADO_SERVICIOTECNICO BOOLEAN DEFAULT FALSE,
    ...
    FOREIGN KEY (ID_FACTURA_SERVICIOTECNICO) REFERENCES FACTURA(ID_FACTURA)
);
...
CREATE TABLE PASSWORDRESET (
    ...
    ID_EMPLEADO_USUARIO INT REFERENCES USUARIO(ID_EMPLEADO_USUARIO),
    TOKEN VARCHAR(255) UNIQUE NOT NULL,
    TOKEN_EXPIRADO TIMESTAMP NOT NULL,
    TOKEN_CREADO TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);

CREATE TABLE INVENTARIOLOCAL_ESTADO (
