...
INSERT INTO ORDENCOMPRA (ID_ORDENCOMPRA, ID_PROVEEDOR_ORDENCOMPRA, FECHA_ORDENCOMPRA, TOTAL_ORDENCOMPRA) VALUES
(1, '123456789-5', '2024-03-12', 250000),
(2, '987654321-7', '2024-02-28', 320000),
(3, '456789123-3', '2024-01-20', 150000),
(4, '789123456-9', '2024-03-05', 275000),
(5, '321654987-4', '2024-03-18', 400000);


INSERT INTO FACTURAPROVEEDOR (ID_FACTURAPROVEEDOR, ID_ORDENCOMPRA_FACTURAPROVEEDOR, FECHA_FACTURAPROVEEDOR, MONTO_FACTURAPROVEEDOR) VALUES
(1001, 1, '2024-03-13', 250000),
(1002, 2, '2024-02-29', 320000),
(1003, 3, '2024-01-21', 150000),
(1004, 4, '2024-03-06', 275000),
(1005, 5, '2024-03-19', 400000);


INSERT INTO DETALLEORDENCOMPRA (
    ID_DETALLEORDENCOMPRA, ID_ORDENCOMPRA_DETALLEORDENCOMPRA, 
    ID_PRODUCTO_DETALLEORDENCOMPRA, CANTIDAD_DETALLEORDENCOMPRA, 
    PRECIOUNITARIO_DETALLEORDENCOMPRA, SUBTOTAL_DETALLEORDENCOMPRA
) VALUES
(1, 1, 1, 5, 50000, 250000),
(2, 2, 1, 4, 80000, 320000),
(3, 3, 2, 10, 15000, 150000),
(4, 4, 3, 11, 25000, 275000),
(5, 5, 2, 8, 50000, 400000);


INSERT INTO ABONOFACTURA (
    ID_ABONOFACTURA, ID_FACTURAPROVEEDOR_ABONOFACTURA, 
    FECHA_ABONOFACTURA, MONTO_ABONOFACTURA
) VALUES
(1, 1001, '2024-03-20', 150000),
(2, 1002, '2024-03-01', 320000),
(3, 1003, '2024-01-25', 75000),
(4, 1004, '2024-03-10', 275000),
(5, 1005, '2024-03-25', 200000);
