...
ALTER TABLE INVENTARIOLOCAL
  ADD CONSTRAINT uq_producto_sede UNIQUE (ID_PRODUCTO_INVENTARIOLOCAL, ID_SEDE_INVENTARIOLOCAL);

ALTER TABLE INVENTARIOLOCAL_ESTADO
  ADD CONSTRAINT uq_producto_sede_estado UNIQUE (ID_PRODUCTO, ID_SEDE, ESTADO);
