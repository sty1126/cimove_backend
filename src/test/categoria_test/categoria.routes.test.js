...
class CategoriaRoutesTest {
  ...
  runAllTests() {
    try {
      ...
      console.log("✅ Todas las pruebas de rutas de categoría pasaron correctamente.");
    } catch (error) {
      console.error("❌ Error en pruebas de rutas de categoría:", error.message);
    }
  }
}

const test = new CategoriaRoutesTest();
test.runAllTests();
