...
class InventarioRoutesTest {
  ...
  runAllTests() {
    try {
      ...
      console.log("✅ Todas las pruebas de rutas de inventario pasaron correctamente.");
    } catch (error) {
      console.error("❌ Error en pruebas de rutas de inventario:", error.message);
    }
  }
}

const test = new InventarioRoutesTest();
test.runAllTests();
